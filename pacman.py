...
def draw():
    ...
    screen.draw.text("Lives: %s" % pacman.lives,
                     topright=(WIDTH-8, 4), fontsize=40)
...
with concurrent.futures.ThreadPoolExecutor() as executor:
    future1: executor.submit(utama)
    future2: executor.submit(minus_point)
